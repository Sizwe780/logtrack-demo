...
        : null;
    } catch (error) { // Added error logging for geocoding
      console.error(`Geocoding failed for ${location}:`, error);
      return null;
    }
  };

  // The fetchTrips function is now defined INSIDE useEffect
...
  }, []);
  ...
  // fetchTrips is now inside useEffect
  useEffect(() => {
    ...
    fetchTrips(); // Call the function here
