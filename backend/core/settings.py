...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    '.onrender.com',  # This allows Render to handle host headers
]
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgresql://logtrack_db_user:A43pZ70f4myEdjra5HPUz2VDHpqM2kC0@dpg-d32qlkur433s73b9sap0-a.oregon-postgres.render.com/logtrack_db',
        conn_max_age=600
    )
}
